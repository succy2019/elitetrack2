...
require_once __DIR__ . '/models/SimpleAdmin.php';

/**
 * Simple Database Initialization Script - File-based storage
 */

echo "Elite Track API - Simple Database Initialization\n";
echo "===============================================\n\n";
...
try {
    ...
    echo "\n🚀 API is ready! Available at: " . $_SERVER['HTTP_HOST'] . "/api/simple.php\n";
    echo "📚 API Documentation: " . $_SERVER['HTTP_HOST'] . "/api/simple.php\n";
    echo "🧪 Test the API: " . $_SERVER['HTTP_HOST'] . "/api/test_simple.php\n";
